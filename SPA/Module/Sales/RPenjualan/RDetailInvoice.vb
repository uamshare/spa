Public Class RDetailInvoice
    ...
    Private Sub showReport(datestart As Date, dateend As Date,
        ...
        Try
            Dim ds As DataSet = Model.FillRDetailinvoice(datestart, dateend, "RDetailInvoice", noref1, noref2)
            Dim param(2) As Microsoft.Reporting.WinForms.ReportParameter
            param(0) = New Microsoft.Reporting.WinForms.ReportParameter("title", "Rincian Penjualan")
            ...
            With ReportViewer1
                ...
                .LocalReport.ReportPath = MyApplication.ReportPath() & "DRDetailPenjualan.rdlc"
                .LocalReport.SetParameters(param)
                .LocalReport.DataSources.Clear()
                .LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("RDetailInvoice", ds.Tables(0)))
