Public Class MDtBibitTanamanMasukH
    Inherits CDataAcces
    ...
    Public mmtrg As Integer = 1

    Public dtcreated As String
    Sub New()
        MyBase.New()
        BaseQuery = "SELECT * FROM trcvmh"
        SelectQuery = "SELECT `trcvmhno`,`trcvmhdt`,`pono`,`podate`,`supplier`,`dtcreated`,`userid` FROM trcvmh_raw ORDER BY 1 DESC"
        Me.TableName = "trcvmh"
        PrimaryKey = "trcvmhno"
    ...
    Public Overloads Function InsertData() As Integer
        ...
        Me.StringSQL = IIf(Not String.IsNullOrEmpty(Me.StringSQL), Me.StringSQL, "INSERT INTO " & TableName + "(`trcvmhno`,`trcvmhdt`,`pono`,`podate`,`supplier`,`userid`,`dtcreated`,`mmtrg`) VALUES " & values)
    ...
    Public Function GetSqlInsertData() As String
        ...
        values = "('" & trcvmhno & "','" & _
                      ...
                      dtcreated & "','" & _
                      mmtrg & "')"
        Return "INSERT INTO " & TableName + "(`trcvmhno`,`trcvmhdt`,`pono`,`podate`,`supplier`,`userid`,`dtcreated`,`mmtrg`) VALUES " & values & ";" & vbCrLf
    End Function
