...
#Region "Format DataGridView"
    ...
    Private Sub RetrieveData(Optional ByVal sSearch As String = "")
        ...
        Catch ex As Exception
            MyApplication.ShowStatus("Gagal menampilkan data = " & ex.Message & vbCrLf & ex.StackTrace, WARNING_STAT)
        End Try
    ...
    Private Sub DataGridView1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles DataGridView1.KeyPress
        'Dim dgrow As DataGridViewRow = DataGridView1.
...
#Region "Pagination"
    ...
    Sub RetrieveLast()
        ...
        RetrieveData()
    End Sub
    Private Sub ToolFisrt_Click(sender As Object, e As EventArgs)
        RetrieveFirst()
    End Sub
    Private Sub ToolPrev_Click(sender As Object, e As EventArgs)
        RetrievePrev()
    End Sub
    Private Sub ToolNext_Click(sender As Object, e As EventArgs)
        RetrieveNext()
    End Sub
    Private Sub ToolLast_Click(sender As Object, e As EventArgs)
        RetrieveLast()
    End Sub
    Private Sub txtPageCurrent_KeyPress(sender As Object, e As KeyPressEventArgs)
    ...
    End Sub
    Private Sub cmbperPage_SelectedIndexChanged(sender As Object, e As EventArgs)
    ...
    Private Sub ToolRefresh_Click(sender As Object, e As EventArgs)
        ...
        ToolTextFind.Text = ""
    End Sub
    Private Sub ToolFind_Click(sender As Object, e As EventArgs)
        Model.startRecord = 0
