Public Class Rstockm
    ...
    End Function
    Public Overloads Function InsertData(ByVal multidata As List(Of Dictionary(Of String, Object))) As Integer
    ...
    Public Function DeleteByNo(ByVal NoHeader As String) As Integer
        Me.StringSQL = "DELETE FROM " & TableName + " WHERE noref='" & NoHeader & "'"
