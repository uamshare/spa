Public Class FTransferStokTanaman
    ...
    Public Sub SetPrivileges()
        Try
            ...
            ButtonAdd2.Visible = MUsers.UserListMenuPrivileges()(MainForm.MenuActive)("pcreate")
            ButtonH2.Visible = MUsers.UserListMenuPrivileges()(MainForm.MenuActive)("pupdate")
            'ToolSaveMenuAkses.Visible = MUsers.UserListMenuPrivileges()(MainForm.MenuActive)("pupdate")
            ButtonDel2.Visible = MUsers.UserListMenuPrivileges()(MainForm.MenuActive)("pdelete")
