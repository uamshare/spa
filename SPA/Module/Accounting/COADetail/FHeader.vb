...
#End Region
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        FCOADetailAdd.txtCoaHeader.Text = CStr(DataGridView1.Rows(e.RowIndex).Cells("mcoahname").Value())
        FCOADetailAdd.txtHeader.Text = Convert.ToString(DataGridView1.Rows(e.RowIndex).Cells("mcoahno").Value())
        FCOADetailAdd.statmsg.Text = CStr(DataGridView1.Rows(e.RowIndex).Cells("mcoahname").Value())
