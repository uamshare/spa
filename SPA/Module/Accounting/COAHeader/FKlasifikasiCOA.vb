    ...
    Private Sub RetrieveData(Optional ByVal sSearch As String = "")
        ...
        Try
            ...
            With DataGridView1
                ...
                .Columns("mcoaclassification").HeaderText = "Klasifikasi COA"
...
#End Region
    ...
    Private Sub ToolAdd_Click(sender As Object, e As EventArgs) Handles ToolAdd.Click
        FKlasifikasiAdd.txtKlasifikasiID.Clear()
        FKlasifikasiAdd.txtGroupID.Clear()
        FKlasifikasiAdd.txtKlasifikasiName.Clear()
        FKlasifikasiAdd.txtGroupName.Clear()
        FKlasifikasiAdd.ShowDialog()
    End Sub
    Private Sub ToolEdit_Click(sender As Object, e As EventArgs) Handles ToolEdit.Click
        If getCountSelectedData() > 0 Then
            FKlasifikasiAdd.txtKlasifikasiName.Text = CStr(DataGridView1.Rows(getRowIndexSelected()).Cells("mcoaclassification").Value)
            FKlasifikasiAdd.txtGroupName.Text = CStr(DataGridView1.Rows(getRowIndexSelected()).Cells("mcoagroup").Value)
            FKlasifikasiAdd.statmsg.Text = CStr(DataGridView1.Rows(getRowIndexSelected()).Cells("mcoagroup").Value)
            FKlasifikasiAdd.txtKlasifikasiID.Text = CStr(DataGridView1.Rows(getRowIndexSelected()).Cells("mcoacid").Value)
            FKlasifikasiAdd.ShowDialog()
        Else
    ...
    Private Sub ToolDelete_Click(sender As Object, e As EventArgs) Handles ToolDelete.Click
        If DataGridView1.RowCount > 0 Then
            Dim mcoacid(DataGridView1.Rows.Count) As String
            For i As Integer = 0 To DataGridView1.Rows.Count - 1
                'delete data
                If DataGridView1.Rows(i).Cells(DGVColumnCheckIndex).FormattedValue = True Then
                    mcoacid(i) = DataGridView1.Rows(i).Cells("mcoacid").Value
                End If
            ...
            If getCountSelectedData() > 0 Then
                ...
                If dr = Windows.Forms.DialogResult.Yes Then
                    ...
                    '    End If
                    'Next
                    Model.MultipleDeleteData(mcoacid)
                End If
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        FCOAheaderAdd.txtKlasifikasi.Text = CStr(DataGridView1.Rows(e.RowIndex).Cells("mcoaclassification").Value())
        FCOAheaderAdd.txtCoaId.Text = CStr(DataGridView1.Rows(e.RowIndex).Cells("mcoacid").Value())
        FDataTanamanAdd.statmsg.Text = CStr(DataGridView1.Rows(e.RowIndex).Cells("mcoaclassification").Value())
